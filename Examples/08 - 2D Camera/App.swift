...
struct Example08: App {
	...
	init() {
		Window.create(800, by: 450, title: "Example 08 - 2D Camera")
	...
	func draw() {
		camera.render {
			for building in buildings {
				Renderer.rectangle(building.rect, color: building.color)
			}

			Renderer.rectangle(player, color: .red)
		...
		Renderer.rectangleOutline(at: 10, 10, size: 250, 113, color: .blue)
