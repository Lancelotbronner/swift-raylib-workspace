...
extension Renderer2D {
	...
	@inlinable public func fps(at x: Int, _ y: Int) {
	...
	@inlinable public func text(center value: String, offset x: Int = 0, _ y: Int = 0, size: Int = Renderer.pointSize, color: Color = Renderer.textColor) {
