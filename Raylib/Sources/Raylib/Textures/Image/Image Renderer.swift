...
public struct RendererImage {
	...
	@inlinable public func clear(to color: Color = Renderer.color) {
	...
	@inlinable public func pixel(at x: Int, _ y: Int, color: Color = Renderer.color) {
		underlying.withMutablePointer { ptr in
	...
	@inlinable public func pixel(at position: Vector2i, color: Color = Renderer.color) {
	...
	@inlinable public func line(from sx: Int, _ sy: Int, to ex: Int, _ ey: Int, color: Color = Renderer.color) {
		underlying.withMutablePointer { ptr in
	...
	@inlinable public func line(from start: Vector2i, to end: Vector2i, color: Color = Renderer.color) {
	...
	@inlinable public func circle(at x: Int, _ y: Int, radius: Int, color: Color = Renderer.color) {
		underlying.withMutablePointer { ptr in
	...
	@inlinable public func circle(at center: Vector2i, radius: Int, color: Color = Renderer.color) {
	...
	@inlinable public func rectangle(at position: Vector2i, size: Vector2i, color: Color = Renderer.color) {
	...
	@inlinable public func image(from source: Rectangle, of other: Image, to destination: Rectangle, tint: Color = Renderer.tint) {
		underlying.withMutablePointer { ptr in
	...
	@inlinable public func text(_ string: String, at x: Int, _ y: Int, size: Int = Renderer.pointSize, color: Color = Renderer.textColor) {
		underlying.withMutablePointer { ptr in
	...
	/// Draw text within an image
	@inlinable public func text(_ string: String, at x: Int, _ y: Int, size: Int = Renderer.pointSize, spacing: Int, using font: Font, color: Color = Renderer.textColor) {
		underlying.withMutablePointer { ptr in
